...
public class TabServiceImpl implements TabService {
    ...
    public int insert(Tab tab) {
        return tabDao.insert(tab);
    }

    public int deleteByPrimaryKey(Integer integer) {
        return tabDao.deleteByPrimaryKey(integer);
    }

    public int updateByPrimaryKeySelective(Tab tab) {
        return tabDao.updateByPrimaryKeySelective(tab);
    }
}
